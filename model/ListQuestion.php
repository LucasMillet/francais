...
class ListQuestion {
	...
	public function ListQuestion(){
		...
		$LesQuestions[0] = new Question("Combien faut-il faire de pages en synthèse ?", "4-5 Pages" ,"3-4 Pages", "2-3 Pages" , "5-6 Pages") ;
		$LesQuestions[1] = new Question("Peut-on faire des citations dans la synthèse ?"," Non !"," Oui !"," ça depends", " Que en d'où provien la citation .") ;
		...
		$LesQuestions[3] = new Question("Peut-on apporter des citations personnelles dans la synthèse"," Non !"," Oui !"," ça depends.", " Que en d'où provien la citation.") ;
		$LesQuestions[4] = new Question("Peut-on apporter des citations personnelles dans la synthèse"," Non !"," Oui !"," ça depends.", " Que en d'où provien la citation.") ;
